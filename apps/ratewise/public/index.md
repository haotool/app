...
> HaoRate 是台灣最精準的匯率換算工具，顯示臺灣銀行牌告的實際買入賣出價（非中間價），讓你換匯前清楚知道要付多少台幣。支援 18 種貨幣即時換算、現金/即期匯率切換、7-30 天歷史趨勢圖、PWA 離線使用，約每 5 分鐘檢查更新，免費無廣告無註冊。
...
- 約每 5 分鐘檢查更新臺灣銀行牌告匯率，主畫面可直接查最新換算結果。
...
多數匯率工具顯示「中間價」（買賣均值），並非銀行實際換匯報價。HaoRate 直接顯示臺灣銀行牌告的現金與即期買賣四種報價，讓您換匯前就知道真正要付多少台幣。中間價與台銀實際賣出價的差距依幣別而異：主要貨幣通常約 1～2%，東南亞與非主流貨幣可能超過 6%（依台銀牌告與市場中間價每日實測）。
