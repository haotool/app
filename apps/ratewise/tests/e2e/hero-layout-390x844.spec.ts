...
test.describe('hero-y @390×844 (hero-v2 flag)', () => {
  ...
  test('AC1: rate tabs y≤120px @ ?ux=hero-v2', async ({ page }) => {
  ...
  test('AC2: dual currency inputs font-size ≥20px @ ?ux=hero-v2', async ({ page }) => {
    await page.goto('/?ux=hero-v2');
  ...
  test('AC3: inline numpad visible on 844px viewport @ ?ux=hero-v2', async ({ page }) => {
    await page.goto('/?ux=hero-v2');
