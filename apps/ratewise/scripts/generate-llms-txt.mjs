...
console.log(
  `✅ llms.txt + llms-full.txt generated: v${VERSION}, ${CURRENCY_SEO_PATHS.length + REVERSE_CURRENCY_SEO_PATHS.length} currency pages (${CURRENCY_SEO_PATHS.length} forward + ${REVERSE_CURRENCY_SEO_PATHS.length} reverse)`,
);
