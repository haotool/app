...
- ${UPDATE_FREQUENCY_PHRASE}臺灣銀行牌告匯率，主畫面可直接查最新換算結果。
...
- ${UPDATE_FREQUENCY_PHRASE}最新報價，涵蓋現金買入、現金賣出、即期買入、即期賣出四種。
...
- **AI 友善**：robots.txt 允許 OpenAI / Anthropic / Perplexity / Google / Apple / DeepSeek / Mistral 等 ${ALL_AI_CRAWLERS.length}+ 主流 AI 爬蟲（四層治理）；提供 llms.txt、llms-full.txt、openapi.json 供 LLM 引用。
...
- 更新頻率：${UPDATE_FREQUENCY_PHRASE}臺灣銀行牌告。
