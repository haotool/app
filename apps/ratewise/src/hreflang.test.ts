 ...
 *
 * [fix:2026-03-07] sitemap.xml 以 public 產物作為 SSOT 驗證來源，
 * 避免 build 前讀取舊 dist 造成假失敗。
 *
...
describe('Hreflang Configuration (BDD)', () => {
  describe('🔴 RED: sitemap.xml Hreflang 配置', () => {
    ...
    it('should have correct xhtml:link elements if hreflang is present', () => {
      ...
      if (xlinkMatches) {
        // SEO_PATHS 24 條 * 2 語言 = 48（7 content + 17 currency，不含 noindex privacy）
        expect(xlinkMatches.length).toBe(48);
      } else {
