...
const ja = {
  ...
  converterV2: {
    ...
    rateBasisCashBuy: '現金買レート',
    rateBasisSpotBuy: '電信買レート',
    rateBasisMid: '仲値',
    ...
    trendBasisSwitchLabel: '推移基準',
    trendGuideLink: '{{code}} ガイドを見る →',
    trendHonestRange: '履歴データは現在 {{days}} 日分のみで、不足期間は推定しません',
    trendEmpty: '履歴データがありません',
    settleAnnouncement: '{{amount}} {{from}} は {{result}} {{to}} です',
    close: '閉じる',
  ...
  settings: {
    ...
    fiveMinutes: '約5分',
    updateNote: '為替レートは約5分ごとに更新を確認します。',
    customThemePresets: 'おすすめカラー',
    customThemeCustomize: 'カスタム…',
    customThemeHex: 'HEXコード',
    customThemePreview: 'メインカラープレビュー',
    customThemeBackgroundTone: '背景トーン',
    ...
    customThemeToneGraphite: 'グラファイト',
    customThemeToneMidnight: 'ミッドナイト',
    customThemeToneBlack: 'ピュアブラック',
    customThemeToneBrightness: 'カスタム明るさ',
    customThemeReset: 'デフォルトテーマに戻す',
    customThemeResetConfirm: 'もう一度タップして確認',
    customThemeContrastNotice: 'この色の文字は読みやすさのため自動的に濃くなります',
    customThemeGateNotice:
      'メインカラーが背景に近すぎるため、アイコンやフォーカス枠が見えにくくなります',
    customThemeGateAdopt: '提案色を使う',
    appVersion: 'アプリバージョン',
  ...
  footer: {
    ...
    disclaimerDesktop: '台湾銀行のレートを約5分ごとに更新確認。参考用のみ。',
    faq: 'よくある質問',
    about: '私たちについて',
