...
const ko = {
  ...
  converterV2: {
    ...
    trendBasisSwitchLabel: '추이 기준',
    trendGuideLink: '{{code}} 가이드 보기 →',
    trendHonestRange: '현재 {{days}}일치 데이터만 제공되며 부족 구간은 추정하지 않습니다',
    trendEmpty: '과거 데이터가 없습니다',
    settleAnnouncement: '{{amount}} {{from}}은(는) {{result}} {{to}}입니다',
    close: '닫기',
  ...
  settings: {
    ...
    fiveMinutes: '약 5분',
    updateNote: '환율 데이터는 약 5분마다 업데이트를 확인합니다.',
    customThemePresets: '추천 색상',
    customThemeCustomize: '커스텀…',
    ...
    customThemeToneGraphite: '그라파이트',
    customThemeToneMidnight: '미드나이트',
    customThemeToneBlack: '퓨어 블랙',
    customThemeToneBrightness: '커스텀 밝기',
    customThemeReset: '기본 테마로 복원',
    customThemeResetConfirm: '한 번 더 눌러 확인',
    customThemeContrastNotice: '이 색상의 텍스트는 가독성을 위해 자동으로 어두워집니다',
    customThemeGateNotice:
      '메인 컬러가 배경과 너무 비슷해 아이콘과 포커스 링이 잘 보이지 않을 수 있습니다',
    customThemeGateAdopt: '추천 색상 사용',
    appVersion: '앱 버전',
  ...
  footer: {
    ...
    disclaimerDesktop: '대만 은행 기준 환율, 약 5분마다 업데이트 확인. 참고용으로만 사용하세요.',
    faq: '자주 묻는 질문',
    about: '소개',
