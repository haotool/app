...
const en = {
  ...
  converterV2: {
    ...
    rateBasisCashBuy: 'Cash buy',
    rateBasisSpotBuy: 'Spot buy',
  ...
  settings: {
    ...
    customThemePreview: 'Primary Color Preview',
    customThemeBackgroundTone: 'Background Tone',
    ...
    customThemeToneGraphite: 'Graphite',
    customThemeToneMidnight: 'Midnight',
    customThemeToneBlack: 'Pure Black',
    customThemeToneBrightness: 'Custom Brightness',
    customThemeReset: 'Restore Default Theme',
    customThemeResetConfirm: 'Tap again to confirm',
    customThemeContrastNotice: 'Text in this color will be darkened automatically for readability',
    customThemeGateNotice:
      'This color is too close to the background; icons and focus rings may be hard to see',
    customThemeGateAdopt: 'Use suggested color',
  ...
  styles: {
    ...
    nitroDesc: 'Dark Tech',
    racing: 'Racing',
    racingDesc: 'Black & Red Racing',
    kawaii: 'Kawaii',
    kawaiiDesc: 'Cute & Pink',
    classic: 'Classic',
    classicDesc: 'Vintage Book',
    forest: 'Forest',
    forestDesc: 'Korean Minimal',
    violet: 'Violet',
