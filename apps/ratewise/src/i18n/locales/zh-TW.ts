...
const zhTW = {
  ...
  converterV2: {
    ...
    rateBasisCash: '現金賣出',
    rateBasisSpot: '即期賣出',
    rateBasisCashBuy: '現金買入',
    rateBasisSpotBuy: '即期買入',
    rateBasisMid: '中間價',
    ...
    trendBasisSwitchLabel: '走勢基準',
    trendGuideLink: '查看 {{code}} 攻略 →',
    trendHonestRange: '目前歷史資料僅 {{days}} 天，不足期間不做推估',
    trendEmpty: '暫無歷史資料',
    settleAnnouncement: '{{amount}} {{from}} 等於 {{result}} {{to}}',
    close: '關閉',
  ...
  settings: {
    ...
    customThemePreview: '主色預覽',
    customThemeBackgroundTone: '背景色調',
    customThemeTonePure: '純淨白',
    customThemeToneWarm: '暖白',
    customThemeToneCool: '冷白',
    customThemeToneMint: '薄荷白',
    customThemeToneRose: '玫瑰白',
    customThemeToneGraphite: '石墨',
    customThemeToneMidnight: '深夜',
    customThemeToneBlack: '純黑',
    customThemeToneBrightness: '自訂亮度',
    customThemeReset: '還原預設主題',
    customThemeResetConfirm: '再點一次確認還原',
    customThemeContrastNotice: '此顏色文字將自動加深以確保可讀',
    customThemeGateNotice: '主色與背景過於接近，圖示與焦點框可能難以辨識',
    customThemeGateAdopt: '採用建議色',
    appVersion: '應用程式版本',
    designSystem: '設計系統',
    techStack: '技術棧',
