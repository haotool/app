...
export function buildPairAmountSeo(
  ...
  if (direction === 'twd-to-foreign') {
    return {
      ...
      description: `${formatted} 台幣今日可換多少${currencyName}？${APP_INFO.shortName} 出國換匯前可查看台銀${currencyName}${CANONICAL_BANK_SELL_THESIS}，資料約每 5 分鐘檢查更新，幫你精確估算可兌換的外幣金額。`,
    };
  }

  return {
    title: `買 ${formatted} ${currencyName}要多少新台幣（${currencyCode}/TWD）| ${APP_INFO.shortName}`,
    description: `買 ${formatted} ${currencyName}今日要多少新台幣？${APP_INFO.shortName} 即時顯示台銀${currencyName}${CANONICAL_BANK_SELL_THESIS}，資料約每 5 分鐘檢查更新，幫你換匯前精確估算所需台幣金額。`,
  };
}
...
export function getCurrencyLandingPageContent(
  ...
  return {
    ...
    description: spotAvailable
      ? `即時查看台銀${displayName}${CANONICAL_BANK_SELL_THESIS}，換匯前確認你真正要付多少台幣。資料來源臺灣銀行官方牌告，約每 5 分鐘檢查更新，支援現金與即期匯率切換，附快速金額按鈕與 7～30 天歷史趨勢圖。適合${override.region}費用估算使用。`
      : `即時查看台銀${displayName}${CANONICAL_BANK_SELL_THESIS}，換匯前確認你真正要付多少台幣。資料來源臺灣銀行官方牌告，約每 5 分鐘檢查更新，附快速金額按鈕與 7～30 天歷史趨勢圖。適合${override.region}費用估算使用。`,
    heroIntro: spotAvailable
      ? `即時查看台銀${displayName}現金牌告匯率，換匯前確認你真正要付多少台幣。資料來源臺灣銀行官方牌告，約每 5 分鐘檢查更新，支援現金與即期匯率切換，附快速金額按鈕與 7～30 天歷史趨勢圖。適合${override.region}費用估算使用。`
      : `即時查看台銀${displayName}現金牌告匯率，換匯前確認你真正要付多少台幣。資料來源臺灣銀行官方牌告，約每 5 分鐘檢查更新，附快速金額按鈕與 7～30 天歷史趨勢圖。適合${override.region}費用估算使用。`,
    pathname,
...
export function getReverseCurrencyLandingPageContent(
  ...
  return {
    ...
    description: spotAvailable
      ? `出國換${displayName}前，先用台銀${CANONICAL_BANK_SELL_THESIS}確認你真正要付多少台幣。資料來源臺灣銀行官方牌告，約每 5 分鐘檢查更新，支援現金與即期匯率切換，附快速金額按鈕與 7～30 天歷史趨勢圖，幫助你合理規劃換匯預算。`
      : `出國換${displayName}前，先用台銀${CANONICAL_BANK_SELL_THESIS}確認你真正要付多少台幣。資料來源臺灣銀行官方牌告，約每 5 分鐘檢查更新，附快速金額按鈕與 7～30 天歷史趨勢圖，幫助你合理規劃換匯預算。`,
    heroIntro: spotAvailable
      ? `出國換${displayName}前，先用台銀現金牌告匯率確認你真正要付多少台幣。資料來源臺灣銀行官方牌告，約每 5 分鐘檢查更新，支援現金與即期匯率切換，附快速金額按鈕與 7～30 天歷史趨勢圖，幫助你合理規劃換匯預算。`
      : `出國換${displayName}前，先用台銀現金牌告匯率確認你真正要付多少台幣。資料來源臺灣銀行官方牌告，約每 5 分鐘檢查更新，附快速金額按鈕與 7～30 天歷史趨勢圖，幫助你合理規劃換匯預算。`,
    pathname,
    canonical: canonicalUrl,
    keywords: [
      override.keyword,
