...
export const HOMEPAGE_SEO = {
  ...
  answerCapsule: [
    ...
    },
    {
      ...
      answer: `中間價是銀行間批發報價，一般民眾換匯必須用「銀行賣出價」，也就是銀行賣外幣給你的價格。${MID_RATE_SPREAD_NOTE}金額越大差距越明顯。`,
    },
    {
...
export const FAQ_PAGE_ENTRIES = [
  ...
  {
    question: '買入和賣出匯率怎麼看？',
    answer: `買入與賣出是站在銀行角度定義的。「銀行買入」是銀行向您收購外幣的價格，您把外幣換回台幣時參考此價；「銀行賣出」是銀行賣外幣給您的價格，您拿台幣換外幣時參考此價。實際規則：出國換外幣看賣出價，回國換台幣看買入價；買賣差距通常在 0.5～3% 之間。${APP_INFO.shortName} 首頁預設顯示「銀行賣出價」（您出國時實際會付的金額），可透過切換按鈕同時查看買入賣出四種報價。`,
  },
  {
    question: '如何使用計算機鍵盤？',
    answer:
