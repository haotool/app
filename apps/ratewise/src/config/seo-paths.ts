...
export const SITE_CONFIG = {
  ...
  name: APP_INFO.name,
  title: `${APP_INFO.shortName} — 台銀牌告買賣價匯率換算器`,
  description: `${APP_INFO.shortName} 以臺灣銀行牌告買賣價為核心，顯示實際買入賣出價（非中間價），協助換匯前參考估算台幣成本。支援 18 種貨幣換算、現金/即期匯率切換、7-30 天歷史趨勢圖、PWA 離線使用，約每 5 分鐘檢查更新，免費無廣告無註冊。`,
