...
const FAQ_ENTRIES = [
  ...
  },
  {
    ...
    answer: '首頁點擊人民幣卡片可展開 7~25 天歷史趨勢圖，視覺化呈現匯率走勢，幫助判斷換匯時機。',
  },
];
        ...
        <div className="container mx-auto px-4 py-10 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow p-5 border border-slate-100">
              <h2 className="text-xl font-semibold text-slate-800 mb-3">🇨🇳 人民幣匯率快速重點</h2>
          ...
          <section className="bg-white rounded-2xl shadow p-6 border border-slate-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-800">人民幣換匯常見問題</h2>
