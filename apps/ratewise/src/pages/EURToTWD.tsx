  ...
  return (
    <>
      <SEOHelmet
        ...
        description="EUR 對 TWD 即時匯率換算，參考臺灣銀行牌告匯率，每 5 分鐘更新。歐元換台幣、歐洲旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別同時換算。"
        pathname="/eur-twd"
        ...
        breadcrumb={[
          ...
          { name: 'EUR → TWD 匯率', item: '/eur-twd/' },
        ]}
        faq={FAQ_ENTRIES}
        howTo={{
          name: '如何查看 EUR 對 TWD 匯率',
          description: '使用 RateWise 3 步驟快速換算歐元對台幣，並查看歷史趨勢與多幣別。',
          steps: HOW_TO_STEPS,
          totalTime: 'PT30S',
        }}
      />

      <main className="min-h-screen bg-gradient-to-br from-neutral-light via-blue-50 to-white">
        <div className="container mx-auto px-4 py-10 max-w-5xl">
          {/* Breadcrumb Navigation */}
          <Breadcrumb
            items={[
              { label: '首頁', href: '/' },
              { label: 'EUR → TWD', href: '/eur-twd/' },
            ]}
          />
          ...
          <div className="flex items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-neutral-text-secondary mt-2">
                即時歐元對台幣匯率，參考臺灣銀行牌告，每 5
                分鐘更新。歐洲旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別模式。
              </p>
            </div>
            <Link
              to="/"
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow p-5 border border-neutral-dark">
              <h2 className="text-xl font-semibold text-neutral-text mb-3">🇪🇺 歐元匯率快速重點</h2>
          ...
          <section className="bg-white rounded-2xl shadow p-6 border border-neutral-dark">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-neutral-text">歐元換匯常見問題</h2>
