/**
 * AUD to TWD Landing Page
 *
 * @description SEO-optimized landing page for AUD to TWD currency conversion.
...
export default function AUDToTWD() {
  return (
    <CurrencyLandingPage
      ...
      description="即時澳幣對台幣匯率，參考臺灣銀行牌告，每 5 分鐘更新。澳洲旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別模式。"
      pathname="/aud-twd"
