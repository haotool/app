...
const FAQ_ENTRIES = [
  ...
  },
  {
    ...
    answer: '首頁點擊新幣卡片可展開 7~25 天歷史趨勢圖，視覺化呈現匯率走勢，幫助判斷換匯時機。',
  },
];
  ...
  return (
    <>
      <SEOHelmet
        ...
        description="SGD 對 TWD 即時匯率換算，參考臺灣銀行牌告匯率，每 5 分鐘更新。新加坡幣換台幣、新加坡旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別同時換算。"
        pathname="/sgd-twd"
        ...
        howTo={{
          ...
          description: '使用 RateWise 3 步驟快速換算新加坡幣對台幣，並查看歷史趨勢與多幣別。',
          steps: HOW_TO_STEPS,
          totalTime: 'PT30S',
        }}
      />
        ...
        <div className="container mx-auto px-4 py-10 max-w-5xl">
          <div className="flex items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-slate-600 mt-2">
                即時新加坡幣對台幣匯率，參考臺灣銀行牌告，每 5
                分鐘更新。新加坡旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別模式。
              </p>
            </div>
            <Link
              to="/"
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow p-5 border border-slate-100">
              <h2 className="text-xl font-semibold text-slate-800 mb-3">🇸🇬 新加坡幣匯率快速重點</h2>
          ...
          <section className="bg-white rounded-2xl shadow p-6 border border-slate-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-800">新加坡幣換匯常見問題</h2>
