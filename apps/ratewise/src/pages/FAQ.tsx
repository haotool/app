...
const FAQ_JSONLD_DATA = [
  ...
  },
  {
    question: '可以查看歷史匯率嗎？',
    answer:
      'RateWise 提供歷史匯率趨勢圖，支援查看過去 7 天、25 天或自訂期間的匯率變化。在單幣別換算模式下，匯率卡片會自動顯示該貨幣對的歷史趨勢線圖，包括最高點、最低點與平均值標記。圖表採用 Recharts 函式庫繪製，支援觸控縮放與數據點查詢。您可以透過趨勢圖了解匯率波動情況，例如「USD/TWD 過去 25 天波動範圍為 30.5-31.2」，幫助您選擇最佳換匯時機。',
  },
];
