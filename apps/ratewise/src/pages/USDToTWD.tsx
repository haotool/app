...
const HOW_TO_STEPS = [
  ...
  },
  {
    position: 3,
    name: '查看趨勢與模式',
    text: '展開卡片可查看 7~25 天歷史趨勢圖，也可切換現金/即期匯率或啟用離線快取。',
  },
];
        ...
        <div className="container mx-auto px-4 py-10 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow p-5 border border-slate-100">
              <h2 className="text-xl font-semibold text-slate-800 mb-3">匯率快速重點</h2>
          ...
          <section className="bg-white rounded-2xl shadow p-6 border border-slate-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-800">常見問題</h2>
