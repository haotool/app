...
const FAQ_ENTRIES = [
  ...
  {
    question: '去瑞士旅遊要換多少瑞士法郎？',
    answer:
      '建議使用 RateWise 換算器輸入預算金額，即可得知台幣對應瑞士法郎。瑞士物價較高，一般建議行程預算 + 30% 餘裕。',
  },
  {
    question: '瑞士法郎匯率走勢如何查看？',
    answer: '首頁點擊瑞士法郎卡片可展開 7~30 天歷史趨勢圖，視覺化呈現匯率走勢，幫助判斷換匯時機。',
  },
];
...
const HOW_TO_STEPS = [
  {
    position: 1,
    name: '選擇瑞士法郎 (CHF)',
    text: '在首頁將「從」設定為 CHF，或在多幣別模式中找到瑞士法郎卡片。',
  },
  {
    position: 2,
    name: '輸入瑞郎金額',
  ...
  return (
    <>
      <SEOHelmet
        ...
        description="CHF 對 TWD 即時匯率換算，參考臺灣銀行牌告匯率，每 5 分鐘更新。瑞士法郎換台幣、瑞士旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別同時換算。"
        pathname="/chf-twd"
        ...
        howTo={{
          ...
          description: '使用 RateWise 3 步驟快速換算瑞士法郎對台幣，並查看歷史趨勢與多幣別。',
          steps: HOW_TO_STEPS,
          totalTime: 'PT30S',
        }}
      />
        ...
        <div className="container mx-auto px-4 py-10 max-w-5xl">
          ...
          <div className="flex items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-neutral-text-secondary mt-2">
                即時瑞士法郎對台幣匯率，參考臺灣銀行牌告，每 5
                分鐘更新。瑞士旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別模式。
              </p>
            </div>
            <Link
              to="/"
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow p-5 border border-neutral-dark">
              <h2 className="text-xl font-semibold text-neutral-text mb-3">🇨🇭 瑞士法郎匯率快速重點</h2>
              <ul className="space-y-3 text-neutral-text">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-red-600 mt-0.5">•</span>
                  <span>瑞士旅遊：蘇黎世、日內瓦、少女峰旅費換算一鍵完成。</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600 mt-0.5">•</span>
          ...
          <section className="bg-white rounded-2xl shadow p-6 border border-neutral-dark">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-neutral-text">瑞士法郎換匯常見問題</h2>
