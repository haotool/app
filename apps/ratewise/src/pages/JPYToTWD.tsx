  ...
  return (
    <>
      <SEOHelmet
        ...
        description="JPY 對 TWD 即時匯率換算，參考臺灣銀行牌告匯率，每 5 分鐘更新。日圓換台幣、日本旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別同時換算。"
        pathname="/jpy-twd"
        ...
        howTo={{
          ...
          description: '使用 RateWise 3 步驟快速換算日圓對台幣，並查看歷史趨勢與多幣別。',
          steps: HOW_TO_STEPS,
          totalTime: 'PT30S',
        }}
      />

      <main className="min-h-screen bg-gradient-to-br from-neutral-light via-rose-50 to-white">
        <div className="container mx-auto px-4 py-10 max-w-5xl">
          ...
          <div className="flex items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-neutral-text-secondary mt-2">
                即時日圓對台幣匯率，參考臺灣銀行牌告，每 5
                分鐘更新。日本旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別模式。
              </p>
            </div>
            <Link
              to="/"
              className="inline-flex items-center gap-2 px-4 py-2 bg-rose-600 text-white rounded-lg shadow hover:bg-rose-700 transition-colors"
            >
              返回主換算器
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow p-5 border border-neutral-dark">
              <h2 className="text-xl font-semibold text-neutral-text mb-3">🇯🇵 日圓匯率快速重點</h2>
            ...
            <div className="bg-rose-600 text-white rounded-2xl shadow p-5">
          ...
          <section className="bg-white rounded-2xl shadow p-6 border border-neutral-dark">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-neutral-text">日圓換匯常見問題</h2>
