...
const FAQ_ENTRIES = [
  {
    question: '加幣匯率數據來源與更新頻率？',
    answer:
      '資料 100% 參考臺灣銀行牌告匯率（現金/即期買入賣出價），每 5 分鐘自動同步一次，首頁會顯示最近更新時間。',
  },
  {
    question: '加幣換算結果與實際交易是否相同？',
    answer:
      'RateWise 提供牌告參考匯率，實際交易匯率可能因銀行或線上換匯平台產生 0.5%~2% 價差，請以交易方公告為準。',
  },
  {
    question: '去加拿大旅遊要換多少加幣？',
    answer:
      '建議使用 RateWise 換算器輸入預算金額，即可得知台幣對應加幣。一般建議行程預算 + 20% 餘裕，並參考當日牌告匯率。',
  },
  {
    question: '加幣匯率走勢如何查看？',
    answer: '首頁點擊加幣卡片可展開 7~30 天歷史趨勢圖，視覺化呈現匯率走勢，幫助判斷換匯時機。',
  },
];
...
const HOW_TO_STEPS = [
  {
    position: 1,
    name: '選擇加幣 (CAD)',
    text: '在首頁將「從」設定為 CAD，或在多幣別模式中找到加幣卡片。',
  },
  {
    position: 2,
    name: '輸入加幣金額',
    text: '輸入 CAD 金額後即時計算對 TWD 的換算結果；多幣別模式可同時查看 30+ 貨幣。',
  },
  {
    position: 3,
    name: '查看歷史趨勢',
...
export default function CADToTWD() {
  return (
    <>
      <SEOHelmet
        title="CAD 對 TWD 匯率換算器 | 即時加幣台幣匯率"
        description="CAD 對 TWD 即時匯率換算，參考臺灣銀行牌告匯率，每 5 分鐘更新。加幣換台幣、加拿大旅遊換匯必備工具，支援現金/即期匯率、離線 PWA、多幣別同時換算。"
        pathname="/cad-twd"
        canonical="https://app.haotool.org/ratewise/cad-twd/"
        keywords={[
          'CAD TWD 匯率',
          '加幣換台幣',
          '加幣匯率',
        ...
        breadcrumb={[
          ...
          { name: 'CAD → TWD 匯率', item: '/cad-twd/' },
        ]}
        faq={FAQ_ENTRIES}
        howTo={{
          name: '如何查看 CAD 對 TWD 匯率',
          description: '使用 RateWise 3 步驟快速換算加幣對台幣，並查看歷史趨勢與多幣別。',
          steps: HOW_TO_STEPS,
          totalTime: 'PT30S',
        }}
      />
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-white">
        <div className="container mx-auto px-4 py-10 max-w-5xl">
          ...
          <div className="flex items-center justify-between gap-4 mb-6">
            ...
            <Link
              to="/"
              className="inline-flex items-center gap-2 px-4 py-2 bg-orange-600 text-white rounded-lg shadow hover:bg-orange-700 transition-colors"
            >
              返回主換算器
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow p-5 border border-slate-100">
              ...
              <ul className="space-y-3 text-slate-700">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-orange-600 mt-0.5">•</span>
                  <span>加拿大旅遊：預估旅費、換匯金額，一鍵換算。</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-orange-600 mt-0.5">•</span>
            ...
            <div className="bg-orange-600 text-white rounded-2xl shadow p-5">
