      ...
      <div className="hidden md:block container mx-auto px-4 md:px-6 py-12 max-w-6xl">
        ...
        <div className="flex flex-row justify-between items-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-slate-800/30 border border-transparent hover:border-slate-700/30 transition-all duration-300"
          >
            ...
            <svg
              ...
              className="w-4 h-4 text-slate-400 group-hover:text-indigo-400 transition-colors duration-300"
              fill="currentColor"
              aria-label="Threads"
            >
