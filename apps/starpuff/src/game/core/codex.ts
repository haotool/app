...
export const CODEX_MONSTERS: readonly CodexMonster[] = [
  ...
  },
  {
    ...
    nameZh: '殼殼',
    behavior: '受擊縮殼旋轉衝刺，衝刺結束會暈眩——趁暈眩吸入即披龜甲護甲',
    inhalable: false,
    conditional: true,
  },
  {
...
export const CODEX_SKILLS: readonly CodexSkill[] = [
  ...
  },
  {
    nameZh: '星暴',
    howTo: '滿匣按 SP 結晶',
    detail: '滿匣按 SP 結晶成頭頂蓄能星，再按 SP 引爆清場；魔王傷害依投入的星值計價，跨關持有',
  },
  {
    nameZh: '星化變身',
    howTo: '同系 3 發按變身鍵',
    detail: '形態持續 10 秒，只消耗該系 3 發；變身中再按變身鍵提前解除（七形態逐區解鎖）',
  },
  {
    nameZh: '焰化',
    howTo: '重鑽味 ×3 按變身鍵',
  ...
  },
  {
    nameZh: '龜甲護甲',
    howTo: '吞下殼殼即自動披甲',
    detail: '20 秒內自動擋下一次任意方向攻擊並反擊星爆；披甲期間吸吐照常，擋下即耗盡',
  },
  {
    nameZh: '雷鏈',
    howTo: '吞雷雷後點按發射',
