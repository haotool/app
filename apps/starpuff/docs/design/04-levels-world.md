...
- L30 崩盤王座：最終魔王關（魔王規格見 §126.2）；魔王關體系沿 §69（前室 400px
  ...
  `L30_ARENA_PLATFORMS` 單一中央低台（`offsetPx=0`、`y=248`、`w=280`）；左右
...
- 實測（Chromium、`scripts/level-audit.mjs`、5 局、cap 90s）：L29 歷史序列為 mid
  6/7（86%）；L30 最新為無變身 high 4/5（80%）、引力化 high 5/5（100%）、mid
  2/5（40%），平均死亡分別為 0.2／0／0.4，三組 console error 皆為 0；後續若
  調整 L30 FSM 或供給，必須以同口徑重跑後更新本段。
