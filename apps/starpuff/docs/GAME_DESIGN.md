...
> 版本：v9.0（PM 親撰；v9 星化與挑戰 §57-§62——星化變身三形態/魔王攻略多樣化與 EX 變體/新怪 Magno·Mirri/L8-L9 九關/慈悲補血、v8 世界擴張 §50-§56——L5-L7 三新關/上升氣流/新怪 ×3/星彈九系/第二魔王 Noctra、v7 手感與深度 §44-§49、v6 存檔/世界地圖/新技能/手感 §38-§43、v5 控制自訂/暫停/圖鑑/開場 §33-§37、v4 免轉向與元素包 §28-§32、v3 橫式轉向 §21-§27）｜路由：`https://app.haotool.org/starpuff/`｜24h 衝刺交付
...
- EX 變體（已通關 L4/L7 節點顯示「EX 挑戰」第二入口；`EX_MODS` 兩魔王共用）：
  - 數值：HP ×1.5（果凍王 90／蝠王 105）、全節奏 ×1.15；入場後緋紅呼吸循環變色演出。
