...
- **難度循序漸進，永不無限卡關**：關卡難度以分級 bot 勝率量化驗收（普通 ≥40%、熟練 ≥80%）。
- **telegraph 可讀性紅線 ≥600ms**：EX 差分只縮體不縮窗。
...
| §60  | v9 關卡 7→9 與世界地圖（levels.ts 資料驅動擴充）（v10 已由 §65 取代：十二關與十二節點）   | [`04-levels-world.md`](design/04-levels-world.md)     |
...
| §65  | v10 關卡 9→12 與世界地圖（levels.ts 資料驅動擴充）（v11 已由 §76 取代：十六關與十六節點） | [`04-levels-world.md`](design/04-levels-world.md)     |
