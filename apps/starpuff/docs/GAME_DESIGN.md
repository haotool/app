...
- 根因（Composer 席）：24 隻 × 12 欄 2 列——854 最窄殼 cellW 67px、行為敘述
...
- 驗證：gridLayout 守門（每頁 6×2 ≤470、24 隻恰兩頁）；v16 e2e 翻頁雙向；
  854/1200/直持截圖對照。
