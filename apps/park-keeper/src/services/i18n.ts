...
const resources = {
  en: {
    translation: {
      ...
      'nav.enable_compass': 'Enable Compass',
      'nav.reenable_compass': 'Re-enable Compass',
      'nav.compass_reason': 'Tap to allow device orientation for navigation',
      'nav.compass_denied': 'Compass Unavailable',
      'nav.compass_denied_hint': 'Reload to request access again',
      'map.marker_car': 'Car',
      'map.marker_you': 'You',
  ...
  'zh-TW': {
    translation: {
      ...
      'nav.gps_waiting': '定位中...',
      'nav.enable_compass': '啟用指南針',
      'nav.reenable_compass': '重新啟用指南針',
      'nav.compass_reason': '點擊以允許使用裝置方向進行導航',
      'nav.compass_denied': '無法使用指南針',
      'nav.compass_denied_hint': '重新整理頁面以再次申請權限',
      'map.marker_car': '車',
      'map.marker_you': '我',
  ...
  ja: {
    translation: {
      ...
      'nav.enable_compass': 'コンパスを有効にする',
      'nav.reenable_compass': 'コンパスを再度有効にする',
      'nav.compass_reason': 'ナビゲーションのためにデバイスの向きを許可してください',
      'nav.compass_denied': 'コンパス利用不可',
      'nav.compass_denied_hint': '再度アクセスを要求するにはページをリロード',
      'map.marker_car': '車',
      'map.marker_you': '現在地',
