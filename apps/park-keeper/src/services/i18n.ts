...
const resources = {
  en: {
    translation: {
      ...
      'record.custom_floor': 'Custom floor/zone',
      ...
      'home.manual_entry': 'Manual entry (no photo)',
      'home.empty_guide_hint': 'Set up a shortcut so recording starts automatically when you park.',
      'record.manage_label': 'Manage record',
  ...
  ja: {
    translation: {
      ...
      'record.custom_floor': 'フロア/エリアを入力',
      'record.plate_unset': 'ナンバー未登録',
      'home.quick_record_cta': 'クイック記録',
      'home.pickup_label': '車へ戻る',
      'home.pickup_hero_aria': '{{floor}} へナビして車を取りに行く',
      'home.just_now': 'たった今',
      'home.manual_entry': '写真なしで記録',
      'home.empty_guide_hint': 'ショートカットを設定すれば、駐車時に自動で記録を開始できます。',
      'record.manage_label': '記録の管理',
      'add.title': 'クイック記録',
