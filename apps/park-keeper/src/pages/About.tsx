      ...
      <footer className="px-6 py-8 text-center border-t border-slate-200">
        ...
        >
          <a
            ...
            rel="author"
            className="inline-block px-1 py-1.5 -mx-1 -my-1.5 text-slate-600 hover:text-slate-800 transition-colors"
          >
            阿璋 (Ah Zhang)
          </a>
          {' · '}
          <a
            ...
            className="inline-block px-1 py-1.5 -mx-1 -my-1.5 text-slate-500 hover:text-slate-700 transition-colors"
          >
            haotool.org
          </a>
          {' · '}
