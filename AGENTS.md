...
2. 檢查 QA 截圖與暫存檔未污染 root
3. 確認受影響文件同步（至少 `AGENTS.md` / `CLAUDE.md`）
4. 使用符合 commitlint 規範的 commit message
...
**版本**: v3.2（補充 Cloudflare 邊緣同步規則，避免 app 發版、worker 標頭與 CDN purge 狀態分裂）
